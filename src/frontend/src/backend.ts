...
import type { Conversation as _Conversation, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addMessage(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getConversations(arg0: bigint, arg1: bigint): Promise<Array<Conversation>> {
        if (this.processError) {
            try {
